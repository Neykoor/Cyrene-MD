...
import { getOwnerFlags, getAdminFlags } from './lib/permissions.js'
...
const { isROwner, isOwner, isMods, isPrems } = await getOwnerFlags(m, this)
...
const { user, bot, isRAdmin, isAdmin, isBotAdmin } = await getAdminFlags(m, this, participants)
